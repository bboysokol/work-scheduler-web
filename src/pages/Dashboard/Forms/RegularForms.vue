				...
				<div>
					<form method="get" action="/" class="form-horizontal">
						...
						<div class="row">
							...
							>
							<div class="col-sm-10">
								<fg-input placeholder="Placeholder"> </fg-input>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-sm-10 checkbox-radios">
								...
								<checkbox v-model="checkboxes.second"
									>Second checkbox</checkbox
								>

								<radio label="1" v-model="radios.radio1"
									>First Radio</radio
								>
								<radio label="2" v-model="radios.radio1"
									>Second Radio</radio
								>
							</div>
						</div>
						...
						<div class="row">
							...
							>
							<div class="col-sm-10 checkbox-radios">
								<checkbox v-model="checkboxes.a" inline
									>a</checkbox
								>
								<checkbox v-model="checkboxes.b" inline
									>b</checkbox
								>
								<checkbox v-model="checkboxes.c" inline
									>c</checkbox
								>
							</div>
						</div>
				...
				<form method="get" action="/" class="form-horizontal">
					<div class="row">
						...
						<div class="col-sm-5 checkbox-radios">
							<radio v-model="radios.radioOn" label="1"
								>Radio is On</radio
							>
							<radio v-model="radios.radioOn" label="2"
								>Radio is Off</radio
							>

							<radio v-model="radios.radioOff" label="1" disabled
								>Radio is On</radio
							>
							<radio v-model="radios.radioOff" label="2" disabled
								>Radio is Off</radio
							>
						</div>
					</div>
