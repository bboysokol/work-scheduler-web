					...
					<div class="row">
						<div class="col-md-4 col-sm-5">
							...
							<n-button class="btn-twitter">
								<i class="fa fa-twitter"></i> Connect with
								Twitter
							</n-button>
							<br />
							...
							<n-button class="btn-google">
								<i class="fa fa-google-plus-square"></i> Share
								on Google+
							</n-button>
							<br />
							...
							<n-button class="btn-youtube">
								<i class="fa fa-youtube-play"></i> View on
								Youtube
							</n-button>
							<br />
							...
							<n-button class="btn-dribbble">
								<i class="fa fa-dribbble"></i> Find us on
								Dribbble
							</n-button>
							<br />
							...
							<n-button class="btn-stumbleupon">
								<i class="fa fa-stumbleupon"></i> View on
								StumbleUpon
							</n-button>
							<br />
						</div>
